<li>
    <a href="{{ route('dashboard.index') }}"
        class="side-menu {{ str_starts_with($ROUTE, 'dashboard.') ? 'side-menu--active' : '' }}">
...
<li>
    <a href="javascript:;" class="side-menu {{ $active ? 'side-menu--active' : '' }}">
        ...
        <div class="side-menu__title">
            {{ __('in-sidebar.trip') }} <div class="side-menu__sub-icon {{ $active ? 'transform rotate-180' : '' }}">
    ...
    <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
        <li>
            <a href="{{ route('trip.index') }}"
                class="side-menu {{ $ROUTE === 'trip.index' ? 'side-menu--active' : '' }}">
        ...
        <li>
            <a href="{{ route('trip.search') }}"
                class="side-menu {{ $ROUTE === 'trip.search' ? 'side-menu--active' : '' }}">
        ...
        <li>
            <a href="{{ route('trip.map') }}"
                class="side-menu {{ $ROUTE === 'trip.map' ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('map')</div>
        ...
        <li>
            <a href="{{ route('trip.heatmap') }}"
                class="side-menu {{ $ROUTE === 'trip.heatmap' ? 'side-menu--active' : '' }}">
...
<li>
    <a href="javascript:;" class="side-menu {{ $active ? 'side-menu--active' : '' }}">
        ...
        <div class="side-menu__title">
            {{ __('in-sidebar.maintenance') }} <div
                class="side-menu__sub-icon {{ $active ? 'transform rotate-180' : '' }}">@icon('chevron-down')</div>
        </div>
    </a>
    ...
    <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
        <li>
            <a href="{{ route('maintenance.index') }}"
                class="side-menu {{ $ROUTE === 'maintenance.index' ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('list')</div>
        ...
        <li>
            <a href="{{ route('maintenance.create') }}"
                class="side-menu {{ $ROUTE === 'maintenance.create' ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('plus-circle')</div>
        ...
        <li>
            <a href="{{ route('maintenance-item.index') }}"
                class="side-menu {{ str_starts_with($ROUTE, 'maintenance-item.') ? 'side-menu--active' : '' }}">
...
<li>
    <a href="javascript:;" class="side-menu {{ $active ? 'side-menu--active' : '' }}">
        <div class="side-menu__icon">@icon('smile')</div>
        <div class="side-menu__title">
            {{ __('in-sidebar.vehicle') }} <div
                class="side-menu__sub-icon {{ $active ? 'transform rotate-180' : '' }}">@icon('chevron-down')</div>
        </div>
    </a>
    ...
    <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
        <li>
            <a href="{{ route('vehicle.index') }}"
                class="side-menu {{ $ROUTE === 'vehicle.index' ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('list')</div>
        ...
        <li>
            <a href="{{ route('vehicle.create') }}"
                class="side-menu {{ $ROUTE === 'vehicle.create' ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('plus-circle')</div>
        ...
        <li>
            <a href="{{ route('vehicle.map') }}"
                class="side-menu {{ $ROUTE === 'vehicle.map' ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('map')</div>
    ...
    <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
        <li>
            <a href="{{ route('device.index') }}"
                class="side-menu {{ $ROUTE === 'device.index' ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('list')</div>
        ...
        <li>
            <a href="{{ route('device.create') }}"
                class="side-menu {{ $ROUTE === 'device.create' ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('plus-circle')</div>
        ...
        <li>
            <a href="{{ route('device.map') }}"
                class="side-menu {{ $ROUTE === 'device.map' ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('map')</div>
...
<li>
    <a href="javascript:;" class="side-menu {{ $active ? 'side-menu--active' : '' }}">
        ...
        <div class="side-menu__title">
            {{ __('in-sidebar.alarm') }} <div class="side-menu__sub-icon {{ $active ? 'transform rotate-180' : '' }}">
                @icon('chevron-down')</div>
        </div>
    </a>
    ...
    <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
        <li>
            <a href="{{ route('alarm.index') }}"
                class="side-menu {{ $ROUTE === 'alarm.index' ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('list')</div>
        ...
        <li>
            <a href="{{ route('alarm.create') }}"
                class="side-menu {{ $ROUTE === 'alarm.create' ? 'side-menu--active' : '' }}">
                <div class="side-menu__icon">@icon('plus-circle')</div>
        ...
        <li>
            <a href="{{ route('alarm-notification.index') }}"
                class="side-menu {{ $ROUTE === 'alarm-notification.index' ? 'side-menu--active' : '' }}">
        ...
        <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
            <li>
                <a href="{{ route('user.index') }}"
                    class="side-menu {{ $ROUTE === 'user.index' ? 'side-menu--active' : '' }}">
                    <div class="side-menu__icon">@icon('list')</div>
            ...
            <li>
                <a href="{{ route('user.create') }}"
                    class="side-menu {{ $ROUTE === 'user.create' ? 'side-menu--active' : '' }}">
                    <div class="side-menu__icon">@icon('plus-circle')</div>
            ...
            <li>
                <a href="{{ route('user-session.index') }}"
                    class="side-menu {{ str_starts_with($ROUTE, 'user-session.') ? 'side-menu--active' : '' }}">
            ...
            <li>
                <a href="{{ route('ip-lock.index') }}"
                    class="side-menu {{ str_starts_with($ROUTE, 'ip-lock.') ? 'side-menu--active' : '' }}">
        ...
        <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
            <li>
                <a href="{{ route('server.status') }}"
                    class="side-menu {{ $ROUTE === 'server.status' ? 'side-menu--active' : '' }}">
            ...
            <li>
                <a href="{{ route('server.index') }}"
                    class="side-menu {{ $ROUTE === 'server.index' ? 'side-menu--active' : '' }}">
                    <div class="side-menu__icon">@icon('list')</div>
            ...
            <li>
                <a href="{{ route('server.create') }}"
                    class="side-menu {{ $ROUTE === 'server.create' ? 'side-menu--active' : '' }}">
                    <div class="side-menu__icon">@icon('plus-circle')</div>
        ...
        <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
            <li>
                <a href="{{ route('city.index') }}"
                    class="side-menu {{ str_starts_with($ROUTE, 'city.') ? 'side-menu--active' : '' }}">
                    <div class="side-menu__icon">@icon('list')</div>
            ...
            <li>
                <a href="{{ route('state.index') }}"
                    class="side-menu {{ str_starts_with($ROUTE, 'state.') ? 'side-menu--active' : '' }}">
                    <div class="side-menu__icon">@icon('list')</div>
            ...
            <li>
                <a href="{{ route('country.index') }}"
                    class="side-menu {{ str_starts_with($ROUTE, 'country.') ? 'side-menu--active' : '' }}">
                    <div class="side-menu__icon">@icon('list')</div>
        ...
        <ul class="{{ $active ? 'side-menu__sub-open' : '' }}">
            <li>
                <a href="{{ route('monitor.index') }}"
                    class="side-menu {{ $ROUTE === 'monitor.index' ? 'side-menu--active' : '' }}">
            ...
            <li>
                <a href="{{ route('monitor.installation') }}"
                    class="side-menu {{ $ROUTE === 'monitor.installation' ? 'side-menu--active' : '' }}">
            ...
            <li>
                <a href="{{ route('monitor.database') }}"
                    class="side-menu {{ $ROUTE === 'monitor.database' ? 'side-menu--active' : '' }}">
            ...
            <li>
                <a href="{{ route('monitor.log') }}"
                    class="side-menu {{ $ROUTE === 'monitor.log' ? 'side-menu--active' : '' }}">
